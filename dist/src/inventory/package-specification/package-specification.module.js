...
PackageSpecificationModule = __decorate([
    common_1.Module({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([package_specification_repository_1.PackageSpecificationRepository]),
        ],
        providers: [package_specification_service_1.PackageSpecificationService],

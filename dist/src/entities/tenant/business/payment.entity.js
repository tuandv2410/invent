...
const payment_status_enum_1 = require("../../../module/tenant/business/enum/payment-status.enum");
...
], PaymentEntity.prototype, "value", void 0);
__decorate([
    nestjsx_automapper_1.AutoMap(),
    typeorm_1.Column({
        nullable: false,
...
__decorate([
    typeorm_1.ManyToOne(type => order_entity_1.OrderEntity, order => order.payments, {
        cascade: true
    }),

...
let BusinessContractService = class BusinessContractService extends base_service_1.BaseService {
    constructor(repository, connection) {
        ...
        this.repository = this.connection.getRepository(business_contract_entity_1.BusinessContractEntity);
    }
};
BusinessContractService = __decorate([
    common_1.Injectable(),
    __param(1, common_1.Inject('CONNECTION')),
    __metadata("design:paramtypes", [business_contract_repository_1.BusinessContractRepository, Object])

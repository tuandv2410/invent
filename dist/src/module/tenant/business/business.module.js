...
BusinessModule = __decorate([
    common_1.Module({
        imports: [order_module_1.OrderModule, business_contract_module_1.BusinessContractModule, payment_module_1.PaymentModule, shipment_module_1.ShipmentModule, product_contract_module_1.ProductContractModule, product_order_module_1.ProductOrderModule, adding_service_module_1.AddingServiceModule]
    })
], BusinessModule);

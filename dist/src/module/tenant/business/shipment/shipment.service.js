...
let ShipmentService = class ShipmentService extends base_service_1.BaseService {
    constructor(repository, connection) {
        super(repository);
        this.connection = connection;
        this.repository = this.connection.getRepository(shipment_entity_1.ShipmentEntity);
    }
};
ShipmentService = __decorate([
    common_1.Injectable(),
    __param(1, common_1.Inject('CONNECTION')),
    __metadata("design:paramtypes", [shipment_repository_1.ShipmentRepository, Object])
], ShipmentService);

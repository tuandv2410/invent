...
let ProductOrderService = class ProductOrderService extends base_service_1.BaseService {
    constructor(repository, connection) {
        ...
        this.repository = this.connection.getRepository(product_order_entity_1.ProductOrderEntity);
    }
};
ProductOrderService = __decorate([
    common_1.Injectable(),
    __param(1, common_1.Inject('CONNECTION')),
    __metadata("design:paramtypes", [product_order_repository_1.ProductOrderRepository, Object])
], ProductOrderService);

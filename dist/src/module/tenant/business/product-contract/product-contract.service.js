...
let ProductContractService = class ProductContractService extends base_service_1.BaseService {
    constructor(repository, connection) {
        ...
        this.repository = this.connection.getRepository(product_contract_entity_1.ProductContractEntity);
    }
};
ProductContractService = __decorate([
    common_1.Injectable(),
    __param(1, common_1.Inject('CONNECTION')),
    __metadata("design:paramtypes", [product_contract_repository_1.ProductContractRepository, Object])

...
PackgingMaterialModule = __decorate([
    common_1.Module({
        providers: [packging_material_service_1.PackgingMaterialService, packging_material_repository_1.PackgingMaterialRepository],
        controllers: [packging_material_controller_1.PackgingMaterialController],
        exports: [packging_material_service_1.PackgingMaterialService]
    })

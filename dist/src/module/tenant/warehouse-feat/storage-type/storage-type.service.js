...
let StorageTypeService = class StorageTypeService extends base_service_1.BaseService {
    constructor(repository, connection) {
        ...
        this.repository = this.connection.getRepository(storage_type_entity_1.StorageTypeEntity);
    }
};
StorageTypeService = __decorate([
    common_1.Injectable(),
    __param(1, common_1.Inject('CONNECTION')),
    __metadata("design:paramtypes", [storage_type_repository_1.StorageTypeRepository, Object])
], StorageTypeService);

...
let StorageBinService = class StorageBinService extends base_service_1.BaseService {
    constructor(repository, connection) {
        ...
        this.repository = this.connection.getRepository(storage_bin_entity_1.StorageBinEntity);
    }
};
StorageBinService = __decorate([
    common_1.Injectable(),
    __param(1, common_1.Inject('CONNECTION')),
    __metadata("design:paramtypes", [storage_bin_repository_1.StorageBinRepository, Object])
], StorageBinService);
